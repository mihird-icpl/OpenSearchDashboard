...
import FirewallManager from './fierwall';

interface SecurityAppDeps {
  basename: string;
...
export const SecurityApp = ({ basename, notifications, http, navigation }: SecurityAppDeps) => {
  ...
  const handleInput = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    // Call your filterAgents function here, e.g., filterAgents('right', value);
  };

  const handleChange = (e: ChangeEvent<HTMLSelectElement>) => {
    // Call your selectAgent function here, e.g., selectAgent('right', e.target);
  };

  const handleReload = () => {
    // Implement or call your reload function here, e.g., reload('left', '', true);
  };

  const handleCancel = () => {
    // Implement or call your cancelButton function here
  };

  const handleLoadMoreAgents = () => {
    // Implement or call your loadMoreAgents function here, e.g., loadMoreAgents('left');
  };
              ...
              <EuiPageBody component="main">
                <EuiPageHeader>
                  <EuiTitle size="l">
                    <h1>
                      <FormattedMessage
                        id="SecurityEvents.helloWorldText"
                        defaultMessage="Welcome to Fierwall Managment Screen"
                    ...
                    <EuiFlexGroup gutterSize="l" wrap>
                      ...
                      <EuiFlexItem>
                        <EuiTitle>
                          <h2>
                            <FormattedMessage
                              id="SecurityEvents.congratulationsTitle"
                              defaultMessage="Firewall Management" />
                          </h2>
                        </EuiTitle>
                      </EuiFlexItem>
                    </EuiFlexGroup>
                  ...
                  <EuiFlexItem grow={6}>
                    <EuiText color='subdued' size="s">
                      <EuiTextAlign textAlign="center">
                        Fierwall Managment Plugin<small>v</small>1.0.3
                      </EuiTextAlign>
                    </EuiText>
                  </EuiFlexItem>
                </EuiFlexGroup>
          ...
          <EuiFlexGroup alignItems="center" justifyContent="spaceAround">
            <EuiFlexItem grow={false}>
              <EuiButton type="primary"
                ...
                <FormattedMessage id="SecurityEvents.buttonText" defaultMessage="Refresh plugin" />
              </EuiButton>
            </EuiFlexItem>
          </EuiFlexGroup>
        </div>
