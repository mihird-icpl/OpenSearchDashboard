  ...
  return (
    ...
    >
      ...
      <EuiFlexItem className="eui-yScroll">
        ...
        <EuiCollapsibleNavGroup
          key={'invinsense'}
          iconType={'https://www.infopercept.com/static/assetsnew/images/invinsense/invinsense-pages/Invinsense_logo.svg'}
          title={'invinsense'}
          isCollapsible={true}
          initialIsOpen={getIsCategoryOpen('invinsense', storage)}
          onToggle={(isCategoryOpen) => setIsCategoryOpen('invinsense', isCategoryOpen, storage)}
          data-test-subj={`collapsibleNavGroup-invinsense`}
          data-test-opensearch-logo={"https://www.infopercept.com/invinsense/"}
        >
          <EuiListGroup>
            {
              unknowns.map((link, i) => (
